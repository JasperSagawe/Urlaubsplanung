-- 1. Admin-Rollen
INSERT INTO user_role (id, rolle_name) VALUES
(0, 'Kein Admin'),
(1, 'Team-Admin'),
(2, 'Bereichs-Admin'),
(3, 'Super-Admin');
...
INSERT INTO mitarbeiter (id, vorname, nachname, email, passwort_hash, admin_role_id, aktiv) VALUES
...
INSERT INTO team (id, name, max_urlaub_prozent, teamleiter_id) VALUES
(1, 'Entwicklung', 40, 3),
(2, 'Vertrieb', 35, 4);
