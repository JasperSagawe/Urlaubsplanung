...
public class Urlaubsantrag {
    ...
    public Urlaubsantrag(Integer id, Mitarbeiter mitarbeiter, LocalDate startDatum, LocalDate endDatum, Integer status, Mitarbeiter genehmigtVon, LocalDateTime antragsdatum) {
        this.id = id;
    ...
    public Mitarbeiter getGenehmigtVon() { return genehmigtVon; }
    public void setGenehmigtVon(Mitarbeiter genehmigtVon) { this.genehmigtVon = genehmigtVon; }

    public LocalDateTime getAntragsdatum() { return antragsdatum; }
    public void setAntragsdatum(LocalDateTime antragsdatum) { this.antragsdatum = antragsdatum; }
